...
const Prizes = () => {
    ...
    const Prize = ({ name, details, image }) => {
        return (<div className="group flex flex-col justify-center items-center my-12 border cursor-default border-nav-links-unselected mx-6 md:mx-12 p-8 hover:border-primary transition duration-300">
    ...
    return <>
        <div className="flex flex-col justify-center items-center bg-black p-4 md:p-8">
            <Title title="Prizes" className="mt-4 mb-12" />
            ...
            <span className="text-nav-links-unselected text-center mb-2">* Conditions apply *</span>
        </div>
    </>
}
