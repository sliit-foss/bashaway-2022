  ...
  return (
    <div className="flex flex-col items-center px-7">
      ...
      <div className="flex flex-row mt-[60px]">
        ...
        <div className="hidden md:flex w-[480px] mx-2"></div>
      </div>
      ...
      <span className="text-sm text-[#888888] font-normal my-[10px]">
        Find the attachment here.
      </span>
      <a href="">
        <div className="flex w-[165px] h-[42px] bg-[#D9D9D9] rounded-sm justify-center items-center text-sm font-normal mb-[80px]">
          Download
        </div>
      </a>
    </div>
